...
var hit : bool
const Bind_Status_Reference := preload("res://objects/battle/battle_resources/status_effects/resources/status_effect_bind.tres")
...
func action():
	...
	if prop: 
		...
		var prop_mesh: MeshInstance3D = held_prop.get_node("MeshInstance3D")
