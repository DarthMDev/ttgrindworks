...
const MOD_EFFECTS : Array[StatusEffect] = [ #res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_drop_immunity.tres
	...
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_sheer_force.tres"), #14 s
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_thorns.tres"), #15 s
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_alphabet.tres"), #16 s
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_red_tape.tres"), #17
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_laborious.tres"), #18 s
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_spongy.tres"), #19
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_ruins.tres"), #20
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_whistleblower_fan.tres"), #21 s
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_litigant.tres"), #22
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_cohesive.tres"), #23
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_sniper.tres"), #24 s
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_bookkeeper_fan.tres"), #25 s
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_hp_guy.tres"), #26 s
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_confused.tres"), #27 s
	preload("res://objects/battle/battle_resources/status_effects/mod_cog_effects/mod_cog_relentless.tres") # 28
...
const PENTHOUSE2_FOREMAN_INDEXES := [14,16,17,18,23]  # sheer+,alphabet,tape , laborious, cohesive for boss pool
var force = true
var cheat_index = -1
var use_strong_cheat = false
var weak_cheat_end_index = 13
var strong_cheat_end_index = 28 
func apply() -> void:
