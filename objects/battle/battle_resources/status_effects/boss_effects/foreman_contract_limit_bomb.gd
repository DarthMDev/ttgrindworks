...
class_name ForemanContractLimitBomb
...
func apply() -> void:
	...
	#movie.tween_callback(target.set_animation.bind("flailing"))
...
func renew() -> void:
	...
	# Cog dies, uh oh!
	movie.tween_callback(manager.show_action_name.bind("Fake Lawyer 😂", "Top Text"))
	movie.tween_callback(target.set_animation.bind("flailing"))
